...
const messages = {
  en: {
    ...
    heroDescription: "Enrolled students sign in with an account; auditing students join with an ID and name. Enter a class code to begin.",
    ...
    noStudentAccount: "Registered and auditing students",
    idNicknameToJoin: "Account login or auditing-student access",
    gradedAfterSubmit: "Graded after submission",
    noAnswersRevealed: "Wrong answers are reviewed after submission",
    ...
    resultPrivacy: "Correct answers are shown below for questions answered incorrectly.",
    question: "Question",
    correct: "Correct",
    incorrect: "Incorrect",
    ...
    customQuizCode: "Custom quiz code (optional)",
    customQuizCodePlaceholder: "e.g. WEEK2QUIZ1",
    customQuizCodeHint: "3–24 letters, numbers, - or _. Leave blank to generate one automatically.",
    ...
    invalidQuizCode: "Use 3–24 letters, numbers, - or _ for the quiz code.",
    quizCodeExists: "That quiz code is already in use. Choose another one.",
    ...
    whoSeesWhatBody: "The public leaderboard shows student names and scores. Student IDs, detailed answers and submission records are visible only to the teacher. Correct answers are shown to a student only after that student submits the quiz.",
...
const apiErrors: Record<string, MessageKey> = {
  ...
  "测验不存在": "quizNotFound",
  "测验代码必须为 3–24 位字母、数字、- 或 _": "invalidQuizCode",
  "这个测验代码已经被使用，请换一个": "quizCodeExists",
};
