...
const messages = {
  en: {
    ...
    heroDescription: "Registered students sign in with an account; auditing students join with an ID and name. Enter a class code to begin.",
