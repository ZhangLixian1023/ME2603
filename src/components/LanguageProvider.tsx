...
const messages = {
  en: {
    ...
    noAnswersRevealed: "Shows which questions were incorrect without revealing answers",
    ...
    resultPrivacy: "Incorrect question numbers are highlighted in red. Correct answers remain hidden.",
    question: "Question",
    correct: "Correct",
    incorrect: "Incorrect",
