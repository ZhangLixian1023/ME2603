...
const messages = {
  en: {
    ...
    heroDescription: "Sign in with your student account, enter the class code and get instant feedback after submission.",
    ...
    noStudentAccount: "Roster-based student accounts",
    idNicknameToJoin: "Sign in with your student ID and password",
